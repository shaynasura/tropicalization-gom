...
result_list_yr1983_2022_m678_western <- purrr::map(species_vec_yr1983_2022_m678_western, ~fish_calculate_gCOB(data = bio_data_clean_yr1983_2022_m678_western,
...
# # Convert to a data frame to ensure that NULLs are converted to NAs
...
```{r Fig_5,  fig.width=8.5, fig.height=9.5}
#| echo: false
