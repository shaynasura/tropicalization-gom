...
# 3. and 4. add the year for the biological catch data and add the specific month an day.
bio_data <- bio_data %>% 
...
## the CRUISE_NO variable from STAREC.csv -> small_starec_data was stored aa character values instead of numeric. Need to convert the CRUISE_NO variable to numeric for it to match the bio_data CRUISE_NO variable.
