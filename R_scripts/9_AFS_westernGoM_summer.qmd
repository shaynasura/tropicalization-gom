...
AFS_base_map <- ggplot() +
  geom_sf(data = world_base_map_sf, color = "black", fill = "white") +
  geom_sf(data = usa_state_borders_sf, color = "black", fill = "white") +
  coord_sf(xlim = c(-97.7, -79.9), ylim = c(18, 31), crs = st_crs(4269)) +
  theme(panel.background = element_rect(fill = c("#CFEFFF")),
        panel.border = element_rect(fill = NA, color = "black")) +
  labs(x = "Longitude", y = "Latitude")
...
# Save the map
ggsave("AFS_figures/blank_GoM_map_v1.png", AFS_base_map, height = 3.5, width = 5)
...
station_data <- data_to_use_here_3 %>%
  ...
  summarize(CRUISEID = unique(CRUISEID),
            ...
            geometry = st_geometry(first(geometry)))  # Retain geometry column # another option is st_union() - I'm not sure what the differences are
...
station_maps <- ggplot() +
  ...
  labs(title = "Trawl Stations for western GoM\n1983 - 2022 June, July, August",
...
animation <- station_maps +
    ...
    ggtitle(label = NULL,  # No main title, just a subtitle
            subtitle = bquote(.(paste0("western GoM Summer 1983-2022\nYear: {frame_time}\nFrame {frame} of {nframes}")))) +
...
anim_save("AFS_figures/westernGoM_yr1983_2022_m678_stations_animated_map1.gif", animation = animated_station_maps)
...
annual_temp_fig <- ggplot(data = temp_surface) +
                      ...
                      # Customization
                      labs(title = "western GoM 1983-2022 summer",
                      ...
                      scale_x_continuous(breaks = seq(1983,2022, by = 4)) +
...
# Save the plot
# ggsave("AFS_figures/westernGoM_19832022_summer_annual_temp_fig1.png", annual_temp_fig, height = 4, width = 5)
ggsave("AFS_figures/westernGoM_19832022_summer_annual_temp_fig1_v1.1.png", annual_temp_fig, height = 3.5, width = 5)
...
temp_surface_maps <- ggplot() +
  ...
  labs(title = "Surface Water Temperature for western GoM\n1983 - 2022 June, July, August",
       x = "Longitude", y = "Latitude")
...
anim_save("AFS_figures/westernGoM_yr1983_2022_m678_temp_surface_anim_map1.gif", animation = animated_temp_surface_maps)
...
# dim(species_df_yr1983_2022_m678_western) # 513 unique taxonomic names
species_vec_yr1983_2022_m678_western <- species_df_yr1983_2022_m678_western$new_TAXON
num_species <- length(species_vec_yr1983_2022_m678_western) # 513 unique taxonomic names
...
westernGoM_19832022_summer_windroses_fig1 <- 
  ...
  labs(x = "Compass Bearing",      # Set x-axis label
       ...
       title = "Western GoM 1983-2022 Summer") +
...
ggsave("AFS_figures/westernGoM_19832022_summer_windroses_fig1_v3.png", westernGoM_19832022_summer_windroses_fig1,
       # height = 11, width = 6,
       height = 4, width = 12)
