...
# for getting species distribution information from FishBase - need to double check this works...
# library(rfishbase) # does not work for me yet
...
glimpse(bio_data_clean)
# head(bio_data_clean)

length(unique(bio_data_clean$new_TAXON))   #1168 unique fish based on new_TAXON
...
## testing out 'rfishbase' package for pulling species distribution information...doesn't work for me yet, sticking with webscraping option below
```{r}

# rfishbase::distribution(species_list(Genus = "Labroides"))
...
# check dimensions
dim(species_df)  ## returns 844 unique taxonomic names after name adjustments above
